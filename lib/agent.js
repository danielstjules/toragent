 ...
 * console output while initializing Tor. Note that since the Tor process is
 * using a new DataDirectory with no cached microdescriptors or any other state,
 * it can take a bit for it to start up. The child process is also killed when
 * node exits.
 *
