...
/**
 * Given a port number and directory path, spawns a Tor promise. Returns a
 * promise that resolves with an instance of the Tor class.
 *
 * @returns {Promise}
 */
Tor.spawn = function(port, dir) {
  return new Promise(function(resolve, reject) {
    ...
    var listener = function(data) {
      ...
      console.log('Tor spawned with pid', child.pid, 'listening on', port);
...
Tor.prototype.destroy = function() {
  return this.signalWait('SIGINT', 'exiting cleanly');
};
